...
function addSearch() {
  ...
  searchHead.classList.add("title");
  ...
  const titles = theNav.querySelectorAll("div.title");
  theNav.insertBefore(searchHead, titles[1]);
  theNav.insertBefore(searchBox, titles[1]);
  ...
  searchBoxButton.onclick = () => {
    ...
    if (searchTarget != null) {
      ...
      searchBoxText.style = "display: initial; color: #247000;";
    } else {
      searchBoxText.innerText = "Couldn't find a name starting with '" + uSearchValue + "'!";
      searchBoxText.style = "display: initial; color: #670000;";
    }
  }
